...
#    params['log10_max_mass'] = 18.63
#    params['n_grid'] = 50000
#    #TODO PRIORITY check safe default on n_grid
#
...
#    mass_grid = 10**np.linspace(-30.,18.63+dlog_M, 500+1)[:-1:]
    ...
    if do_sanity_checks:
        ...
        for itr in xrange(0,hmf.mass_grid.size):
    ...
    if do_plot_test2:
       ...
       # dndM_G=hmf.dndM_G(Ms,Gs)
        ...
        if do_sheth_bias_comp1:
            ...
            C2.k = P2.k
            params2 = params.copy()
            params2['f_norm_overwride'] = False
            params2['b_norm_overwride'] = False
...
#        params['log10_max_mass'] = 18.63
#        params['n_grid'] = 12640
#        params['b_norm_overwride'] = False#True
#        params['n_z'] = 5./0.5
#        hmf = ST_hmf(C,params=params)
#        Ms = hmf.mass_grid 
