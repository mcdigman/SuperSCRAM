...
#            cosmo_strip = cp.strip_cosmology(cosmo_start,p_space='jdem')
#            cosmo_fid = cp.add_derived_pars(cosmo_strip)
#            As[itr] = cosmo_fid['As']
...
#        k_0,P_0,sigma8_0 =camb_pow(cosmo_start,camb_params=camb_params,nonlinear_model=camb.model.NonLinear_none)
#        C_0=cp.CosmoPie(cosmo_start,needs_power=False)
#        C_0.k=k_0
#        G_0 = C_0.G(0.)
#        halofit_params =defaults.halofit_params.copy()
#        halofit_params['cutoff']=False
#        hf_0 = hf.HalofitPk(C_0,P_0,halofit_params=halofit_params)
#
#        n_w = ws.size
...
#            kls[itr],Pls[itr],sigma8ls[itr] = camb_pow(cosmo_start,camb_params=camb_params,nonlinear_model=camb.model.NonLinear_none)
#            Cs[itr].k=kls[itr]
#            if itr==0:
...
#            hfs[itr] = hf.HalofitPk(Cs[itr],Pls[itr],halofit_params=halofit_params)
...
#            #if itr>0:
#            hf2s[itr] = hf.HalofitPk(C4s[itr],Peffs[itr],halofit_params=halofit_params)
#            hf4s[itr] = hf.HalofitPk(C4s[itr],P_0*mult4s[itr,0],halofit_params=halofit_params)
...
#            #else:
#            #    hf2s[itr] = hf.HalofitPk(Cs[itr],P_0*mul)
#            #    hf4s[itr] = hf.HalofitPk(C4s[itr],P_0*mult4s[itr,0])
