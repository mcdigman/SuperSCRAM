...
cosmology_cosmosis={'Omegabh2' :0.049,
				...
				'Omegak'   : 0.0, # check on this value 
				'Omegar'   : 0.0}
lensing_params = {  'z_resolution'    :0.1, #fine resolution
                    'z_min_integral'  :0.1, #lowest z
