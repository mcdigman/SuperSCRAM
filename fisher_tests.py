...
def test_chol_right_cov(fisher_params):
    """test contract_chol_right consistency"""
    cov = fisher_params.fisher_input.cov.copy()
    chol_cov = fisher_params.fisher_input.chol_cov.copy()
    fisher = copy.deepcopy(fisher_params.fisher)
    ...
    contracted4 = fisher.contract_covar(cov,cov,identical_inputs=True,return_fisher=False)
    contracted5 = np.dot(cov.T,np.dot(cov,cov))

    atol_loc1 = np.max(np.abs(contracted1))*atol_rel_use
...
def test_chol_right_range2(fisher_params):
    ...
    contracted1 = fisher.contract_chol_right(range_mat2)
    contracted2 = np.dot(chol_cov.T,range_mat2)
    contracted6 = fisher.contract_chol_right(range_mat1)
    contracted7 = np.dot(chol_cov.T,range_mat1)
    contracted3 = np.dot(contracted7.T,contracted2)
    contracted4 = fisher.contract_covar(range_mat1,range_mat2,identical_inputs=True,return_fisher=False)
    contracted5 = np.dot(range_mat1.T,np.dot(cov,range_mat2))
...
def test_chol_i_right_fab(fisher_params):
    """test contract_chol_inv_right consistency"""
    fab = fisher_params.fisher_input.fab.copy()
    chol_cov_i = fisher_params.fisher_input.chol_cov_i.copy()
    fisher = copy.deepcopy(fisher_params.fisher)
    ...
    contracted3 = np.dot(contracted2.T,contracted2)
    contracted4 = fisher.contract_fisher(fab,fab,identical_inputs=True,return_fisher=False)
    contracted5 = np.dot(fab.T,np.dot(fab,fab))
...
def test_chol_i_right_range2(fisher_params):
    ...
    contracted1 = fisher.contract_chol_inv_right(range_mat2)
    contracted2 = np.dot(chol_cov_i,range_mat2)
    contracted6 = fisher.contract_chol_inv_right(range_mat1)
    contracted7 = np.dot(chol_cov_i,range_mat1)
    contracted3 = np.dot(contracted7.T,contracted2)
    contracted4 = fisher.contract_fisher(range_mat1,range_mat2,identical_inputs=True,return_fisher=False)
    contracted5 = np.dot(range_mat1.T,np.dot(fab,range_mat2))
